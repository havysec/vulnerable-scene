...
$rowcount = 1;
	...
	echo "<table class='table' width='100%' class='table'>
		<tr class='table_header'>
			<td colspan='7'>All images uploaded by: $username</td>
		</tr>
		<tr class='row3'>
			<td>Thumbnail</td>
			<td>Image name</td>
	...
	$query1 = mysql_query("SELECT * FROM ".$prefix."images WHERE img_uploader = '".$username."'");
	while ($row1 = mysql_fetch_array($query1)) {
		...
		$query = mysql_query("SELECT * FROM ".$prefix."votes WHERE vote_ip='".$userip."' AND vote_image_id=".$imgid);
